...
Route::resource('project', App\Http\Controllers\ProyectController::class);
...
Route::post('portafolio/{proyect}/restore', [App\Http\Controllers\ProyectController::class, 'restore'])->name('projects.restore');
Route::delete('portafolio/{proyect}/forceDelete', [App\Http\Controllers\ProyectController::class, 'forceDelete'])->name('projects.forceDelete');
...
// Route::resource('proyects', PortafolioController::class); //apiResource o resource
    ...
    // Route::post('asd/{project}/asd', [App\Http\Controllers\ProyectController::class, 'nuevo']);
    ...
    // Route::delete('/portafolio/{project}/forceDelete', [ProyectController::class,'forceDelete'])->name('projects.forceRestore');
